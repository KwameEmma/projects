...
<body style = "background-color: #eeeeee;">
 ...
 <a href="login.php" class="get-started-btn" style = "background-color: #2F5878;">Log out</a>
      </div>
...
<div class="form-row" style="width:100%;">
  ...
  <div class="form-row" style="width:100%;">
    <div class="form-group col-md-6" style="width:100%;">
     <input type="text" class="form-control" name = "programme" id="inputEmail4" placeholder="Programme" required>
    </div><br>
    <div class="form-group col-md-6" style="width:100%;">
     <input type="text" class="form-control" name = "completion_year" id="inputPassword4" placeholder="Year of Completion" required>
    </div><br>
      <div class = "card" style = "width: 40%; position: relative; left: 5%;">
    ...
    <div class="form-check">
      ...
      <option value="HND Med Lab">HND Med Lab</option>
