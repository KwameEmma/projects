...
<body style = "background-color: #eeeeee;">
  ...
  <header id="header" class="fixed-top" style = "background-color: #2F5878;">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a href="hodhome.php" style = "color: white;">Home</a></li>
         <li><a href="hoddashboard.php" style = "color: white;">Dashboard</a></li>
         <!-- <li><a class="active" href="hodrequest.php">View Request</a></li> -->
 ...
 <a href="hodlogout.php" class="get-started-btn" style = "background-color: #2F5878; color: white;">Log out</a>
      </div>
  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
           <div class = "container card" style = "width: 75%; height: 100hv;">
             ...
             <!-- Form -->
               <form method = "POST" action = "hodrequestserver.php">
    ...
    <div class="form-group col-md-6" style="width:100%;">
     <input type="text" class="form-control" name = "surname" id="inputEmail4" value = "<?php echo $status;?>" readonly>
    </div>
    </select>
...
<div class="form-row" style="width:100%;">
    <div class="form-group col-md-6" style="width:100%;">
     <input type="text" class="form-control" name = "surname" id="inputEmail4" value = "<?php echo $surname;?>" readonly>
    </div><br>
    <div class="form-row" style="width:100%;">
    <div class="form-group col-md-6" style="width:100%;">
...
<h6 style = "width: 40%; position: relative; left: 5%;">Please indicate the class awarded on your certificate</h6>
  ...
  <div class="form-row" style="width:100%;">
    ...
    <div class="form-group col-md-2" style="width:100%;">
     <input type="text" class="form-control" name = "staffsign" id="inputZip" placeholder = "Head of division academic affairs Signed..." value = "<?php echo $staffsign;?>" readonly>
    </div>
  </div><br>
  <div class="form-group col-md-2" style="width:100%;">
     <input type="text" class="form-control" name = "hodsign" id="inputZip" placeholder = "Head of student services Signed..." required>
    </div>
  </div><br>
