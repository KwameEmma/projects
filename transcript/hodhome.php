  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <!-- <li><a class="active" href="staffhome.php">Home</a></li> -->
         ...
         <li class="dropdown"><a href="#"><span>Request Type</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="hodresults.php">Detailed Result</a></li>
               <li><a href="hodtranscripts.php">Transcript</a></li>
      ...
      <a href="hodlogin.php" class="get-started-btn">Logout</a>
    ...
    <section id="courses" class="courses"> <br><br>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" style = "height: 300px; position: elative; left: 60%;">
...
<h6 style = "position: relative; bottom: 20px;">STUDENT NAME: <?php echo $_SESSION['username'];?></h6>
<h6 style = "position: relative; bottom: 20px;">DEPARTMENT: <?php echo $_SESSION['department'];?></h6>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" style = "height: 300px; position: relative; right: 4%;">
            <div class="course-item card">
              <img src="" class="img-fluid" alt=""><br><br>
               ...
               <a class="bi bi-folder d-flex align-items-center justify-content-center" style = "position: relative; right: 2%;"> <span style = "position: relative; left: 5%;">Detailed Results</span></a> 

              <a class="bi bi-envelope d-flex align-items-center justify-content-center" style = "position: relative; right: 8%;"> <span style = "position: relative; left: 5%;">Transcript</span></a>

              <a class="bi bi-lock d-flex align-items-center justify-content-center"> <span style = "position: relative; left: 5%;">Change Password</span></a>
