...
?>
   ...
   <?php
               ...
               $results = mysqli_query($con,"SELECT *  FROM attended WHERE newindex = '{$index_no}'");
               $row = mysqli_fetch_array($results);
           
               $staffsign = $row['staffsign'];
               $hodsign = $row['hodsign'];
                             ?>
                           <h5 style = "padding: 5; margin: 5; position: relative; right: 25%;">Signed</h5>
             <strong style = "padding: 5; margin: 5; position: relative; right: 25%;">Head of division academic affairs: </strong><br>
             <u style = "padding: 5; margin: 5; position: relative; right: 25%;"><?php echo $staffsign; ?></u>
             
             <h5 style = "padding: 5; margin: 5; position: relative; left: 30%; bottom: 80px;">Signed</h5>
             <strong style = "padding: 5; margin: 5; position: relative; left: 30%; bottom: 80px;">Head of student services</strong><br>
             <u style = "padding: 5; margin: 5; position: relative; left: 30%; bottom: 80px;"><?php echo $hodsign; ?></u>
                          </div>
