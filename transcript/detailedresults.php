      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
         ...
         <li><a href="staffdashboard.php" style = "color: white;">Dashboard</a></li>
          <li><a href="staffrequest.php" style = "color: white;">View Request</a></li>
         <li class="dropdown"><a href="#" class="active" style = "color: white;"><span>Request Type</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
      <li><a class="active" href="detailedresults.php?newindex=<?=$newindex?>">Detailed Result</a></li>
