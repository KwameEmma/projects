...
<body>
               <div style = "width: 100%; height: 80px; background-color: #2F5878; text-align: center;"><br>
                              <h5 style = "padding: 5px; color: white;">STUDENT TRANSCRIPT SYSTEM | H. O. D (STUDENT SERVICES) LOGIN</h5>
               </div>                        
               <center>
                               <div class = "card" style = "width: 30%; position: relative; top: 60px; height: 250px;">

                     <form action="hodserver.php" method = "POST"><br><br>
                       <input type="text" name="username" id="username" value = "Ansomaa Gifty" class="username" placeholder = "Username" required style = "width: 90%; height: 40px; padding-top: 10px;"><br><br>
                       <input type="password" name="password" id="password" value = "1234" class="password" placeholder = "Password" required style = "width: 90%; height: 40px;"><br><br>
